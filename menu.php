  ...
  <div class="z-row noMargin">
    <div class="z-block h50">
      ...
      <div class="z-content-fluid z-contentMiddle text-right">
        <a id="openSearch" role="button" class="cLightGrey s15">
          <span class="fa fa-search s25"></span>
        </a>
      </div>
    </div>
  </div>
...
<aside id="sidebar" off-canvas="asideNav left push" role="navigation" class="mainContainer sidebar boxShadowRight bgLightBlue">
  <div class="sidebar-nav">
    <div class="list-group bgTransparent noBorder square">
      <a href="main.html" role="button" class="list-group-item cLightGrey s20 square noBorder noMargin bgTransparent">
...
<aside class="searchSidebar sidebar boxShadowLeft bgLightBlue" off-canvas="searchNav right push" role="panel" class="mainContainer sidebar boxShadow bgWhite">
  <div class="clear"></div>
